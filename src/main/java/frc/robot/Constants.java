...
public final class Constants
{
  ...
  public static final class IntakeHead {
   ...
   public static final class ShooterConstants {
    ...
    public static final int bottomShooterMotorVelocity = 4800;//5250
    public static final int topAmpMotorVelocity = 750;
    public static final int bottomAmpMotorVelocity = 750;
   }
