...
public class RobotContainer
{
  ...
  { 
    ...
    NamedCommands.registerCommand("Shoot1", new score(m_scoreWheels).withTimeout(3));
    NamedCommands.registerCommand("PickUp", new in(m_intake).withTimeout(3));
    NamedCommands.registerCommand("armDown", new InstantCommand(() -> m_arm.pickup()));
    NamedCommands.registerCommand("armShoot", new InstantCommand(() -> m_arm.shoot()));
  ...
  private void configureBindings()
  {
        ...
        new JoystickButton(secondaryXbox, XboxController.Button.kStart.value).toggleOnTrue(new InstantCommand(() -> m_arm.shoot()));
        ...
        new JoystickButton(secondaryXbox, XboxController.Button.kLeftBumper.value).whileTrue(new ampScore(m_scoreWheels));
  ...
  public Command getAutonomousCommand()
  {
    ...
    //PathPlannerPath path = PathPlannerPath.fromPathFile("SkalskyTest");
